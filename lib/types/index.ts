...
export interface TrackEvents {
    login: (payload: { page_from: string; click_button: string; description: string }) => void;
    get_code: (payload: { description: string }) => void;
    set_nickname: (payload: { description: string }) => void;
    ...
    prd_pageview: (payload: { page_name: string; description: string }) => void;
    official_pageview: (payload: { page_name: string; description: string }) => void;
}
